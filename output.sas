...
C -1 PNE derived!1.0()
D 2 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate2)
C -1 PNE derived!28.0()
D 4 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate4)
D 0 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate0)
C -1 PNE derived!67.0()
C -1 PNE derived!90.0()
D 11 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate5, truck0)
C -1 PNE derived!101.0()
C -1 PNE derived!10.0()
D 7 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate1, truck0)
C -1 PNE derived!85.0()
C -1 PNE derived!506.0()
D 6 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate0, truck0)
C -1 PNE derived!0.0()
D 5 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate5)
D 1 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate1)
D 3 PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(truck0, crate3)
C -1 PNE derived!46.0()
D 8 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate2, truck0)
D 9 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate3, truck0)
D 10 PNE derived!difference_PNE derived!sum_PNE current_load(?z)_PNE weight(?y)(?z, ?y)_PNE load_limit(?z)(truck0, crate4, truck0)
R -1 PNE current_load(truck0)
R -1 PNE fuel_cost()
I -1 PNE total-cost()
...
end_operator
begin_operator
drop hoist0 crate1 pallet2 depot0
0
5
0 1 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate1 pallet3 depot0
0
5
0 1 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate2 pallet2 depot0
0
5
0 2 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate2 pallet3 depot0
0
5
0 2 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate3 pallet2 depot0
0
5
0 3 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate3 pallet3 depot0
0
5
0 3 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate4 pallet1 depot0
0
5
0 4 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate4 pallet2 depot0
0
5
0 4 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate4 pallet3 depot0
0
5
0 4 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate5 pallet1 depot0
0
5
0 5 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist0 crate5 pallet3 depot0
0
5
0 5 -1 0
0 7 -1 0
...
end_operator
begin_operator
drop hoist1 crate0 pallet0 distributor0
0
5
0 0 -1 1
0 8 -1 0
...
end_operator
begin_operator
drop hoist1 crate1 pallet0 distributor0
0
5
0 1 -1 1
0 8 -1 0
...
end_operator
begin_operator
drop hoist1 crate2 pallet0 distributor0
0
5
0 2 -1 1
0 8 -1 0
...
end_operator
begin_operator
drop hoist1 crate3 pallet0 distributor0
0
5
0 3 -1 1
0 8 -1 0
...
end_operator
begin_operator
drop hoist1 crate4 pallet0 distributor0
0
5
0 4 -1 1
0 8 -1 0
...
end_operator
begin_operator
drop hoist1 crate5 pallet0 distributor0
0
5
0 5 -1 1
0 8 -1 0

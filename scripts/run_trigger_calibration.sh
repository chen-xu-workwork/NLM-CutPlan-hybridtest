...
export NLM_LLM_ANALYSIS_INTERVAL="${NLM_LLM_ANALYSIS_INTERVAL:-8192}"
...
export NLM_LLM_ANCESTOR_DEPTH="${NLM_LLM_ANCESTOR_DEPTH:-10}"
export NLM_LLM_MIN_DEPTH="${NLM_LLM_MIN_DEPTH:-20}"
